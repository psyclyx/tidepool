...
pub fn build(b: *Build) !void {
    ...
    // --- Janet (dynamic for build-time, static for final binary) ---
    ...
    gen_protocols.addDirectoryArg(b.path("protocol"));
    ...
    // --- Final Executable ---
    const tidepool = b.addExecutable(.{
        .name = "tidepool",
        .root_module = b.createModule(.{
            .target = target,
            .optimize = optimize,
    ...
    tidepool.addCSourceFile(.{ .file = generated });
