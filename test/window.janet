...
(def o1 (t/make-output {:tags @{1 true}}))
(def w1 (t/make-window 1 {:tag 1 :w 100 :h 100}))
(def w2 (t/make-window 2 {:tag 2 :w 100 :h 100}))
...
(t/test-start "compute-visibility: no dimensions not visible")
(def o1 (t/make-output {:tags @{1 true}}))
...
(def w1 (t/make-window 1 {:tag 1 :w 100 :h 100}))
(def w2 (t/make-window 2 {:tag 2 :w 100 :h 100}))
(def w3 (t/make-window 3 {:tag 3 :w 100 :h 100}))
