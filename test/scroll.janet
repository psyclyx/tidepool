...
(def w1 @{:wid 1})
(def l1 (tree/leaf w1))
(def result (scroll/layout-node l1 {:x 10 :y 20 :w 800 :h 600} ig bw 0))
...
(def result (scroll/layout-node c {:x 0 :y 0 :w 800 :h 600} ig bw 1))
...
(def l2 (tree/leaf w2))
(def c (tree/container :split @[l1 l2]))
(def result (scroll/layout-node c {:x 0 :y 0 :w 800 :h 600} ig bw 0))
(t/assert-eq (length result) 2)
...
(def result (scroll/layout-node c {:x 0 :y 0 :w 100 :h 100} ig bw 1))
...
(def result (scroll/layout-node tb {:x 0 :y 0 :w 800 :h 600} ig bw 0))
(t/assert-eq (length result) 1)
...
(def result (scroll/layout-node outer {:x 0 :y 0 :w 800 :h 600} ig bw 1))
(t/assert-eq (length result) 3)
