...
(t/test-start "grow-width: adjusts focused horizontal split child")
(tree/reset-ids)
(def wa @{:wid 1})
(def wb @{:wid 2})
(def la (tree/leaf wa 1.0))
(def lb (tree/leaf wb 1.0))
(put wa :tree-leaf la)
(put wb :tree-leaf lb)
(def c (tree/container :split @[la lb]))
(def cols @[c])
(def tag (make-tag cols wa))
(def ctx (make-scroll-ctx tag {:split-resize-step 0.25}))
(def seat (make-scroll-seat wa))
(sa/grow-width ctx seat)
(t/assert-eq (la :width) 1.25 "focused child grew")
(t/assert-eq (lb :width) 0.75 "neighbor shrank")

(t/test-start "shrink-width: adjusts focused horizontal split child")
(sa/shrink-width ctx seat)
(t/assert-eq (la :width) 1.0 "focused child shrank")
(t/assert-eq (lb :width) 1.0 "neighbor grew")

(t/test-start "grow-height: adjusts focused vertical split child")
(tree/reset-ids)
(def wa @{:wid 1})
(def wb @{:wid 2})
(def la (tree/leaf wa 1.0))
...
(def cols @[col])
(def tag (make-tag cols wa))
(def ctx (make-scroll-ctx tag {:split-resize-step 0.2}))
(def seat (make-scroll-seat wa))
(sa/grow-height ctx seat)
(t/assert-eq (la :width) 1.2 "focused vertical child grew")
(t/assert-eq (lb :width) 0.8 "vertical neighbor shrank")

(t/test-start "grow-width: falls back to column width")
(tree/reset-ids)
(def wa @{:wid 1})
(def la (tree/leaf wa))
(put wa :tree-leaf la)
...
(put col :width 1.0)
(def tag (make-tag cols wa))
(def ctx (make-scroll-ctx tag {:column-resize-step 0.2}))
(def seat (make-scroll-seat wa))
(sa/grow-width ctx seat)
(t/assert-eq (col :width) 1.2)

(t/test-start "reset-size: resets nearest split children")
(tree/reset-ids)
(def wa @{:wid 1})
(def wb @{:wid 2})
(def la (tree/leaf wa 1.4))
(def lb (tree/leaf wb 0.6))
(put wa :tree-leaf la)
(put wb :tree-leaf lb)
(def c (tree/container :split @[la lb]))
(def cols @[c])
...
(def ctx (make-scroll-ctx tag))
(def seat (make-scroll-seat wa))
(sa/reset-size ctx seat)
(t/assert-eq (la :width) 1.0)
(t/assert-eq (lb :width) 1.0)

(t/test-start "reset-size: resets column when no split sibling")
(tree/reset-ids)
(def wa @{:wid 1})
(def la (tree/leaf wa))
(put wa :tree-leaf la)
...
(put col :width 1.6)
(def tag (make-tag cols wa))
(def ctx (make-scroll-ctx tag {:default-column-width 0.7}))
(def seat (make-scroll-seat wa))
(sa/reset-size ctx seat)
(t/assert-eq (col :width) 0.7)
