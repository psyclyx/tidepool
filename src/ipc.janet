...
(reg-action "focus-next" actions/focus-next)
(reg-action "focus-prev" actions/focus-prev)
(reg-action "swap-next" actions/swap-next)
(reg-action "swap-prev" actions/swap-prev)
